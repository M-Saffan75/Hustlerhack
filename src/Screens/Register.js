                            ...
                            <View style={styles.short_Container_here}>
                                ...
                                <View style={{ width: '100%' }}>
                                    ...
                                    <View style={styles.number_container}>
                                        ...
                                        <TextInput placeholder='7xxxxxx' placeholderTextColor={'grey'} keyboardType='number-pad' style={styles.inpt_here} onChangeText={setMobile_No} />
                                    </View>
                                    ...
                                    <View style={styles.number_container_pswd}>
                                        <TextInput placeholder='Your Password' secureTextEntry={hidePass ? true : false} placeholderTextColor={'grey'} style={styles.inpt_here_pswd} onChangeText={setPassword} />
                                    ...
                                    {password_error == true ? (
                                        <View style={{ display: password.length >= 2 ? 'none' : 'flex' }}>
                                            <Text style={styles.phone_error}>Password is Required*</Text>
                                        </View>
                                    ) : null
                                    }
                                    ...
                                    <View style={styles.number_container_pswd}>
                                        <TextInput placeholder='Confirm Password' secureTextEntry={hide ? true : false} placeholderTextColor={'grey'} style={styles.inpt_here_pswd} onChangeText={setConfirm_Password} />
                                    ...
                                    <View style={styles.btn_container}>
                                        <TouchableOpacity activeOpacity={0.9} style={styles.btn_indside} onPress={() => navigation.navigate('Details')}>
