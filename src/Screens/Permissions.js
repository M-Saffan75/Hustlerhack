...
import { Image, ImageBackground, StatusBar, StyleSheet, Text, TouchableOpacity, View, Animated, ModalPoup, Modal, BackHandler, AppState, ScrollView } from 'react-native'
...
const Permissions = ({ navigation }) => {
    ...
    const handleScroll = (event) => {
        ...
        const isScrolledToEnd = contentOffset.y >= contentSize.height - layoutMeasurement.height;
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                    ...
                    <View style={styles.short_container}>
                        <View style={{ width: '100%' }}>
                            <View style={styles.image_container}>
                                <Image source={require('../images/h.png')} style={{ justifyContent: 'center', alignItems: 'center', width: 100, height: 50, }} resizeMode='contain' />
                            </View>
                            <View>
                                <Text style={styles.content}>Permissions Disclosure & privacy policy</Text>
                            </View>

                            <View style={styles.permission_here}>
                                <Text style={styles.permission}>Permissions</Text>
                            </View>
                            <View style={styles.text_box}>
                                {/* <Text style={styles.text_here}> */}
                                <Text style={styles.text_here}>Frequently asked questions...</Text>
                                <Text style={styles.text_here_question}></Text>
                                <Text style={styles.text_here}>
                                    Privacy Policy & t&c
                                    Privacy Policy for Hustlerhack
                                    At HUSTERHACK, accessible from HUSTLERFUNDHACK.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by HUSTLERHACK and how we use it.
                                    If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
                                    Log Files
                                    Hustlerhack follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services’ analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users’ movement on the website, and gathering demographic information.
                                    Privacy Policies
                                    You may consult this list to find the Privacy Policy for each of the advertising partners of Husterhack.
                                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Hustlerhack, which are sent directly to users’ browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
                                    Note that Hustlerhack has no access to or control over these cookies that are used by third-party advertisers.
                                    Third Party Privacy Policies
                                    Hustlerhack Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.
                                    You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers’ respective websites. What Are Cookies?
                                    Children’s Information
                                    Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.
                                    Hustlerhack does not knowingly collect any Personal Identifiable Information from children under the age of 18. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
                                    Online Privacy Policy Only
                                    This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Hustlerhack. This policy is not applicable to any information collected offline or via channels other than this website.
                                    Consent
                                    By using our website, you hereby consent to our Privacy Policy and agree to its Terms and Conditions.
                                    Terms & Conditions
                                    Hustler Fund Hack terms of Use and Loan Account Agreement – Kenya
                                    Terms and Conditions for the Opening and Use of a Loan Account with Hustler Fund Hack
                                    WHEREAS
                                    This Agreement is a financial service and an end-user license agreement between you (“End-user” or “you”) and Hustler Fund Hack (“HFH”, “us” or “we”) for the mobile application software, the data supplied with the software and the associated Services (defined below) (“App”)
                                    This Agreement (together with our Privacy Policy) sets out the complete terms and conditions (the “Terms and Conditions”) which shall be applicable to the Account (as hereinafter defined) opened by you with HFH.
                                    ...
                                    Account means your loan account with HFH;
                                    ...
                                    Force Majeure means events, circumstances or causes beyond its reasonable control of HFH making HFH’s performance of its obligations inadvisable, commercially impracticable, illegal, or impossible, including but not limited to acts of God, war, strikes or labour disputes, embargoes or government orders;
                                    ...
                                    Loan means the principal amount of the loan made or to be made by HFH to you under this Agreement from time to time through the App or (as the context requires) the principal amount outstanding for the time being of that loan;
                                    ...
                                    Privacy Policy means the HFH privacy policy that sets out the basis on which any personal data we collect from you, or that you provide to us, will be processed by us;
                                    Request means a request or instruction received by HFH from you or purportedly from you through the Network and the System and upon which HFH is authorized to act;
                                    Services shall include any form of financial services or products that HFH may offer you pursuant to this Agreement and as you may from time to time subscribe to and “Service” shall be construed accordingly;
                                    ...
                                    System means HFH electronic communications software enabling you to communicate with HFH for purposes of the Services. The System and the Services will for the purpose of this Agreement be accessed through a Mobile Network Operator’s System;
                                    Technology has the meaning given to it in clause 3.1.4; and
                                    Transaction and Application Fees includes any fees and charges payable for the use of the Services as published by HFH on HFH’s website or by such other means as HFH shall in its sole discretion determine. Transaction Fees are subject to change at any time at HFH’s sole discretion.
                                    Interpretation
                                    ...
                                    You must carefully read and understand the Terms and Conditions set out in this Agreement and as amended from time to time by HFH (the Terms and Conditions) before downloading or streaming the App or opening an account with HFH which will govern the use and operation of the App and the Account.
                                    ...
                                    By downloading the App and opening an Account with HFH, you agree to comply with and be bound by the Terms and Conditions governing the operation of the Account, including but not limited to the payment of a non-refundable registration fee and you affirm that the Terms and Conditions herein are without prejudice to any other right that HFH may have with respect to the Account in law or otherwise.
                                    These Terms and Conditions may be amended or varied by HFH from time to time and the continued use of the Services constitutes your agreement to be bound by the terms of any such amendment or variation. HFH will take all reasonable measures to notify you of any changes.
                                    ...
                                    USE OF THE SERVICES
                                    The Services offered by HFH can only be utilized by persons over the age of 18.HFH reserves the right to verify the authenticity and status of your Mobile Money Account with the relevant Mobile Money Provider.
                                    ...
                                    HFH reserves the right to decline your application for a loan or to revoke the same at any stage at HFH’s sole and absolute discretion and without assigning any reason or giving any notice thereto.
                                    HFH reserves the right (in its sole and absolute discretion) to issue, decline to issue a loan and/or vary the terms of any loan depending on its assessment of the credit profile of each individual borrower from time to time. The terms of the loan and the interest rate payable in relation to each loan application will be displayed on the App.
                                    ...
                                    You hereby irrevocably authorize HFH to act on all Requests received by HFH from you (or purportedly from you) through the System and to hold you liable in respect thereof. HFH may nevertheless refuse to carry out any Requests in its sole and absolute discretion.
                                    ...
                                    TAXES
                                    All payments to be made by you in connection with these Terms and Conditions are calculated without regard to any taxes payable by you. If any taxes are payable in connection with the payment, you must pay HFH an additional amount equal to the payment multiplied by the appropriate rate of tax. You must do so at the same time as making the payment.
                            ...
                            <ModalPoup visible={visible}>
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    <View style={styles.header}>
                                        <Text style={{ color: COLOURS.black, fontFamily: 'Roboto-Bold' }}>Notice</Text>
                                    </View>
                                </View>

                                <View style={{ alignItems: 'center', }}>
                                    <Text style={{ color: COLOURS.black, fontFamily: 'Roboto-Medium', textAlign: 'center', letterSpacing: .3, fontSize: 13, }}>
                                        In order to evaluate your qualifications and provide you with better services, we need your authorization to collect your relevant information. Please confirm whether to deny the permission and understand that this operation will exit the APP, or cancel the operation?
                                    </Text>
                                ...
                                <View style={{ alignItems: 'center', marginTop: '10%' }} >
                                    <View style={styles.btn_container}>
                                        <TouchableOpacity activeOpacity={0.9} style={styles.btn_indside_outline} onPress={() => setVisible(false)}>
                                            <Text style={styles.btn_txt_outline}>Cancel</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity activeOpacity={0.9} style={styles.btn_indside} onPress={handleButtonPress}>
                ...
                <View style={styles.btn_container_Here}>
                    <TouchableOpacity activeOpacity={0.9} style={styles.btn_indside_outline_new} onPress={() => setVisible(true)}>
                        <Text style={styles.btn_txt_outline_new}>I DISAGREE</Text>
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={0.9} style={[styles.btn_indside,{backgroundColor:scrolledToEnd ? COLOURS.hex : '#1b1b1b'}]} onPress={() => navigation.navigate('Login')}>
                        <Text style={styles.btn_txt}>I AGREE</Text>
                    </TouchableOpacity>
                </View>
                {/*  */}
